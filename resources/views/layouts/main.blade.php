        ...
        <div class="collapse navbar-collapse" id="navbar-toggler">
          ...
          <ul class="navbar-nav ml-auto">
            @guest
             ...
             <li class="nav-item mr-2"><a href="{{ route('login') }}" class="btn btn-outline-secondary">{{ __('Login') }}</a></li>
               @if (Route::has('register'))
               <li class="nav-item"><a href="{{ route('register') }}" class="btn btn-outline-primary">{{ __('Register') }}</a></li>
               @endif
